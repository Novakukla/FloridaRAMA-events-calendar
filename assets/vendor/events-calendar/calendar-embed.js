(function () {
  ...
  style.textContent =
    ...
    '.fr-event-card { display: flex; flex-direction: column; font-size: 11px; color: #fff; width: 100%; box-sizing: border-box; min-height: 200px; font-family: inherit; }' +
    ...
    '.fr-cal-modal-body { padding: 18px 22px 22px; font-family: inherit; }' +
